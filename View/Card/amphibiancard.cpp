#include "amphibiancard.h"


AmphibianCard::AmphibianCard(const Amphibian& aValue, QWidget* parent)
    : value{aValue}, QWidget{parent}
{
    ...
    name->setMargin(2);
    name->setObjectName("nameAmphibianCard");


    type = new QLabel;
    QImage typeImage{":/Img/Images/Icons/frog.png"};
    ...
    //larval stage
    std::vector<QString> v{QString::fromStdString(value.getLarvalStageImgPath())};
    larvalStage = new LabelImage{tr("Larval Stage"), v};
    ...
    layout->addWidget(larvalStage, 6, 6, 4, 5);
...
void AmphibianCard::paintEvent(QPaintEvent* e)
{
    QStyleOption option;
