#include "mammalcard.h"

#include <QLabel>
#include <QHBoxLayout>

MammalCard::MammalCard(const Mammal& aValue, QWidget* parent)
    : value{aValue}, QWidget{parent}
{
    ...
    name->setMargin(2);
    name->setObjectName("nameMammalCard");


    type = new QLabel;
    QImage typeImage{":/Img/Images/Icons/milking.png"};
    ...
    std::vector<QString> v{QString::fromStdString(value.getFootprintImgPath())};
    footprint = new LabelImage{tr("Footprint"), v};
    ...
    layout->addWidget(footprint, 6, 6, 4, 5);
...
void MammalCard::paintEvent(QPaintEvent* e)
{
    QStyleOption option;
