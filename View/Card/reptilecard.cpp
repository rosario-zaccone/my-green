#include "reptilecard.h"


ReptileCard::ReptileCard(const Reptile& aValue, QWidget* parent)
    : value{aValue}, QWidget{parent}
{
    ...
    name->setMargin(2);
    name->setObjectName("nameReptileCard");

    type = new QLabel;
    QImage typeImage{":/Img/Images/Icons/lizard.png"};
    ...
    QString scaleIcon;
    int scaleType{static_cast<int>(value.getScaleType())};
    switch (scaleType) {
        case 0:
            scaleIcon = ":/Img/Images/Icons/semicircle.png";
            break;
        case 1:
            scaleIcon = ":/Img/Images/Icons/shield.png";
            break;
        case 2:
            scaleIcon = ":/Img/Images/Icons/embri.png";
            break;
        case 3:
            scaleIcon = ":/Img/Images/Icons/armor.png";
            break;
    }

    std::vector<QString> v{scaleIcon};
    scale = new LabelImage{tr("Scale Type"), v};
    scale->setMaximumSize(180, 180);
    ...
    layout->addWidget(scale, 6, 6, 4, 5, Qt::AlignCenter);
    layout->addWidget(noiseButton, 6, 11, 4, 4);
...
void ReptileCard::paintEvent(QPaintEvent* e)
{
    QStyleOption option;
